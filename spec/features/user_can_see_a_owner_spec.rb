...
RSpec.feature "When I visit a specific owner" do
  scenario "I see the owner's name, a list of his units and total earnings" do
    ...
    owner1.units.create(name: "1a", square_footage: 20, monthly_rent: 1000)
    owner1.units.create(name: "1b", square_footage: 20, monthly_rent: 1000)
    owner2.units.create(name: "2a", square_footage: 20, monthly_rent: 1000)
