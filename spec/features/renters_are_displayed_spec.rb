...
RSpec.feature "When someone visits '/renters'" do
  scenario "they see a list of renters with their apartments" do
    ...
    Unit.create(name: "1a", square_footage: 10, monthly_rent: 1000, cost_per_square_foot: 100, renter: renter1)
    Unit.create(name: "1b", square_footage: 20, monthly_rent: 1000, cost_per_square_foot: 50, renter: renter2)
